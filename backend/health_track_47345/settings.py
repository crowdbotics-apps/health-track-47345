"""
Django settings for health_track_47345 project.
...
ROOT_URLCONF = 'health_track_47345.urls'
...
WSGI_APPLICATION = 'health_track_47345.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "health_track_47345 API",
    "DESCRIPTION": "API documentation for health_track_47345 App",
    "VERSION": "v1",
}
